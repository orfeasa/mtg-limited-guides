...
- Follow `docs/set-lifecycle.md`: Previews during reveals; Archetypes after the full file and authored plans are verified; All cards replaces Previews on retail release; Training requires complete attributable ratings. Default to the most useful available task. Draft decisions additionally requires grounded pack-and-pool evidence.
