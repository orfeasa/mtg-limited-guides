...
console.log(`Verified preparation content and 13 invalid-content rejection cases (${set.prep.keyCards.length} key cards, ${set.prep.exercises.length} exercises).`);
