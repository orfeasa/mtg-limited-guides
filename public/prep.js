  ...
  function create(root, actions) {
    ...
    function render(nextSet, nextFormat) {
      ...
      root.innerHTML = `
        ...
        <nav class="prep-jumps" aria-label="In this preparation guide"><a href="#prep-mechanics">Mechanics</a><a href="#prep-cards">Cards to know</a>${set.earlyEvidence ? '<a href="#prep-combinations">Combinations</a>' : ""}<a href="#prep-play-around">Play around</a><a href="#prep-colours">Find your colours</a><a href="#prep-checklist">Deck checklist</a><a href="#prep-practice">Quick practice</a></nav>
